...
export const Actions = () => {
  ...
  useEffect(() => {
    fetch("http://localhost/form-react/all-users.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const insertUser = (newUser) => {
    fetch("http://localhost/form-react/add-user.php", {
      method: "POST",
      headers: {
  ...
  const updateUser = (userData) => {
    fetch("http://localhost/form-react/update-user.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteUser = (theID) => {
    ...
    fetch("http://localhost/form-react/delete-user.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
